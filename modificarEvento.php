...
<body>
  ...
  if (isset($_POST["aceptar"])) {
        ...
        $modificarEvento= "UPDATE eventos SET  
        ID_usuario_inicio_evento = '$promotor_inicial',
        ID_usuario_final_evento = '$promotor_final', 
        ID_referido_evento = '$referido', 
        ID_domicilio_evento = '$domicilio', 
        ID_domicilio_evento = '$domicilio', 
        ID_estado_evento = '$estadoEvento', 
        fecha = '$fecha', Horario = '$horario', 
        observacion = '$observacion' WHERE ID_evento = '$ID_evento'";
        $resultado = $mysqli->query($modificarEvento);

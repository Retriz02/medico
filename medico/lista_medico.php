...
<body>
    <div class="container">
        <div class="title">
            ...
            <a href="agregar_medico.php" target="paginaPrincipal">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="eliminar_medico.php?id=<?php echo $medico["ID_medico"] ?>" class="botones">Eliminar</a></td>
                        <td><a href="modificar_medico.php?id=<?php echo $medico["ID_medico"] ?>" class="botones">Modificar</a></td>

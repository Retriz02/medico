...
<?php 
    ...
    if ($varsesion == null || $varsesion = '') {
        ...
        if ($_SESSION["area"] == "Comercial"){
            //si la sesion llamada area correspone a comercial lo redirecciona a la pantalla de su area
            echo "";
...
<FRAMESET ROWS=9%,* noresize>
    ...
    <FRAME SRC="Medico/frames/frame_superior.php"></FRAME> <!-- Se define el frame superior de la pantalla -->
    <!-- Dimensiones de los frames -->
    <FRAMESET COLS=14%,66%,20% FRAMEBORDER=0>
        <FRAME SRC="Medico/frames/frame_navegador.php" name="navegador"></FRAME> <!-- Frame izquierdo para mostrar el navegador -->
